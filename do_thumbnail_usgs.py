...
if __name__=='__main__':
    ...
    good = down_util.BestsceneWoker(ref_root, pr_lists[0], startdate, enddate, thumb_root, copydir=r'Z:\yinry\china.mosaic\basemap0620\good', df=df, monthlist=[5, 6, 7, 8, 9])
